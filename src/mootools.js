...
web build:
 - http://mootools.net/core/714771899b6e6cc17097c248709186e8

packager build:
 - packager build Core/Event Core/Class Core/Fx.Tween Core/DOMReady
...
}};var d=function(h){var g=e[h];if(g){g.erase(this);if(!g.length&&c[h]){delete e[h];c[h]=clearInterval(c[h]);}}};})();(function(){var k,n,l,g,a={},c={},m=/\\/g;
...
p[o]={};p.borderWidth[n]=p[o][n]=l[n]="@px";p.borderStyle[k]=p[o][k]=l[k]="@";p.borderColor[m]=p[o][m]=l[m]="rgb(@, @, @)";});})();Fx.CSS=new Class({Extends:Fx,prepare:function(c,d,b){b=Array.from(b);
...
b.callChain();}.bind(this));return this;}});(function(){Element.Properties.events={set:function(b){this.addEvents(b);}};[Element,Window,Document].invoke("implement",{addEvent:function(f,h){var i=this.retrieve("events",{});
